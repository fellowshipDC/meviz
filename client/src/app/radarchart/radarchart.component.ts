...
export class RadarchartComponent implements OnInit {
  ...
  RadarChart(parent_selector, data, options) {
    ...
    const allAxis = this.conteo[8]['values']['key'].map((i, j) => i.key),	//Names of each axis
  ...
  ngOnInit() {
    ...
    height = Math.min(width, window.innerHeight - margin.top - margin.bottom);
     ...
     //get the data
    var data = d3.csv('./assets/museo.csv', (error, data) => {
      ...
      var conteo = d3.nest()
        ...
        .entries(data); //Visualizing  categories
    ...
    //let svg_radar1 = this.RadarChart(".radarChart", data, radarChartOptions);
